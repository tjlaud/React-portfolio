    ...
    <div>
      <div className="projects-container">
        ...
        <div>
          ...
          <p>
            A React App to track sleep hours. An exercise in building a
            functional UI. Using React, Material UI and SCSS.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            A dice rolling game. Two versions are available one in vanilla JS
            and one built with React.
          </p>
        </div>
